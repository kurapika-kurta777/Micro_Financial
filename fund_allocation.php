...
<div class="page-content">
  ...
  <div class="page-header">
    ...
    <div class="page-header-text">
      ...
      <p>Track fund sources, allocations, and disbursement distribution.</p>
    </div>
    <div class="page-header-actions">
      <button class="btn btn-primary"><i class='bx bx-plus'></i> Add Fund Source</button>
    </div>
  </div>
  ...
  <div class="stat-grid">
    ...
    <div class="stat-card">
      <div class="stat-icon green"><i class='bx bx-transfer-alt'></i></div>
      <div class="stat-info">
        <div class="stat-label">Total Allocated</div>
        <div class="stat-value">&#8369;0</div>
        <div class="stat-sub">Disbursed to loans</div>
      </div>
    </div>
    <div class="stat-card">
      ...
      <div class="stat-info">
        ...
        <div class="stat-value">&#8369;0</div>
        <div class="stat-sub">Available to allocate</div>
      </div>
    </div>
    <div class="stat-card">
      ...
      <div class="stat-info">
        ...
        <div class="stat-value">0</div>
        <div class="stat-sub">Registered sources</div>
      </div>
    </div>
  </div>
  ...
  <div class="card">
    ...
    <!-- Tab Bar -->
    <div class="tab-bar">
      <button class="tab-btn active" onclick="switchTab(this,'tab-allocations')">Fund Allocations</button>
      <button class="tab-btn" onclick="switchTab(this,'tab-disbursements')">Disbursement Tracker</button>
    </div>

    <!-- Tab: Fund Allocations -->
    <div id="tab-allocations" class="tab-pane active">

      <!-- Tab Card Header -->
      <div class="card-header" style="border-top:none;border-bottom:1px solid var(--border);">
        <div class="card-title"><i class='bx bx-money'></i> Fund Allocations</div>
      ...
      </div><!-- /Fund Allocations Table -->

    </div><!-- /tab-allocations -->

    <!-- Tab: Disbursement Tracker -->
    <div id="tab-disbursements" class="tab-pane">

      <!-- Tab Card Header -->
      <div class="card-header" style="border-top:none;border-bottom:1px solid var(--border);">
        <div class="card-title"><i class='bx bx-transfer-alt'></i> Disbursement Tracker</div>
        <div class="card-actions">
          <button class="btn btn-outline btn-sm"><i class='bx bx-filter-alt'></i> Filter</button>
          <button class="btn btn-outline btn-sm"><i class='bx bx-export'></i> Export</button>
          <button class="btn btn-primary btn-sm"><i class='bx bx-plus'></i> Record Disbursement</button>
        </div>
      </div>

      <!-- Disbursement Tracker Table -->
      <div class="table-wrap">
        <table>
          <thead>
            <tr>
