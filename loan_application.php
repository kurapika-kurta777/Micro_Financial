...
<div class="page-content">
  <div class="page-header">
    <div class="page-header-icon"><i class='bx bx-file'></i></div>
    <div class="page-header-text">
      <h2>Loan Application &amp; Disbursement</h2>
      <p>Handle loan requests, approvals, and fund disbursement.</p>
    </div>
    <div class="page-header-actions">
      <button class="btn btn-primary"><i class='bx bx-plus'></i> New Application</button>
    </div>
  </div>

  <div class="stat-grid">
    <div class="stat-card"><div class="stat-icon blue"><i class='bx bx-file-blank'></i></div><div class="stat-info"><div class="stat-label">Total Applications</div><div class="stat-value">0</div><div class="stat-sub">All time</div></div></div>
    <div class="stat-card"><div class="stat-icon green"><i class='bx bx-check-circle'></i></div><div class="stat-info"><div class="stat-label">Approved</div><div class="stat-value">0</div><div class="stat-sub">Ready for disbursement</div></div></div>
    <div class="stat-card"><div class="stat-icon orange"><i class='bx bx-time-five'></i></div><div class="stat-info"><div class="stat-label">Pending</div><div class="stat-value">0</div><div class="stat-sub">Under review</div></div></div>
    <div class="stat-card"><div class="stat-icon teal"><i class='bx bx-transfer'></i></div><div class="stat-info"><div class="stat-label">Total Disbursed</div><div class="stat-value">₱0</div><div class="stat-sub">Released funds</div></div></div>
  </div>

  <div class="card">
    <div class="tab-bar">
      <button class="tab-btn active" onclick="switchTab(this,'tab-apps')">Applications</button>
      <button class="tab-btn" onclick="switchTab(this,'tab-approved')">Approved Loans</button>
      <button class="tab-btn" onclick="switchTab(this,'tab-disbursed')">Disbursements</button>
    </div>

    <div id="tab-apps" class="tab-pane active">
      <div class="card-header" style="border-top:none;">
        <div class="card-title"><i class='bx bx-file'></i> Loan Applications</div>
        <div class="card-actions"><button class="btn btn-primary btn-sm"><i class='bx bx-plus'></i> New Application</button></div>
      </div>
      <div class="table-wrap"><table>
        <thead><tr><th>Client</th><th>Amount Requested</th><th>Purpose</th><th>Date</th><th>Status</th><th>Actions</th></tr></thead>
        <tbody><tr><td colspan="6"><div class="empty-state"><i class='bx bx-file-blank'></i><p>No records found.</p></div></td></tr></tbody>
      </table></div>
    </div>

    <div id="tab-approved" class="tab-pane">
      <div class="card-header" style="border-top:none;">
        <div class="card-title"><i class='bx bx-check-circle'></i> Approved Loans</div>
        <div class="card-actions"><button class="btn btn-primary btn-sm"><i class='bx bx-plus'></i> Record Approval</button></div>
      </div>
      <div class="table-wrap"><table>
        <thead><tr><th>Loan ID</th><th>Client</th><th>Amount</th><th>Interest Rate</th><th>Term</th><th>Balance</th><th>Actions</th></tr></thead>
        <tbody><tr><td colspan="7"><div class="empty-state"><i class='bx bx-check-square'></i><p>No records found.</p></div></td></tr></tbody>
      </table></div>
    </div>

    <div id="tab-disbursed" class="tab-pane">
      <div class="card-header" style="border-top:none;">
        <div class="card-title"><i class='bx bx-transfer-alt'></i> Disbursements</div>
        <div class="card-actions"><button class="btn btn-primary btn-sm"><i class='bx bx-plus'></i> Record Disbursement</button></div>
      </div>
      <div class="table-wrap"><table>
        <thead><tr><th>Loan ID</th><th>Amount</th><th>Method</th><th>Date</th><th>Processed By</th><th>Actions</th></tr></thead>
        <tbody><tr><td colspan="6"><div class="empty-state"><i class='bx bx-transfer'></i><p>No records found.</p></div></td></tr></tbody>
      </table></div>
    </div>
  </div>
</div>
