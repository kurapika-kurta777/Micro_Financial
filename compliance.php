...
<div class="page-content">
  ...
  <div class="page-header">
    ...
    <div class="page-header-actions">
      <button class="btn btn-outline btn-sm"><i class='bx bx-export'></i> Export Logs</button>
      <button class="btn btn-primary"><i class='bx bx-plus'></i> Add Compliance Record</button>
    </div>
  </div>
