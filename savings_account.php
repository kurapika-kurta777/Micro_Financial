...
<div class="page-content">
  ...
  <div class="page-header">
    ...
    <div class="page-header-actions">
      <button class="btn btn-primary"><i class='bx bx-plus'></i> Open Account</button>
    </div>
  </div>
  ...
  <div class="card">
    ...
    <div id="tab-accounts" class="tab-pane active">
      ...
      <div class="card-header" style="border-top:none;border-bottom:1px solid var(--border);">
        ...
        <div class="card-actions">
          <button class="btn btn-primary btn-sm"><i class='bx bx-plus'></i> Open Account</button>
        </div>
      </div>
    ...
    <div id="tab-transactions" class="tab-pane">
      ...
      <div class="card-header" style="border-top:none;border-bottom:1px solid var(--border);">
        ...
        <div class="card-actions">
          <button class="btn btn-primary btn-sm"><i class='bx bx-plus'></i> Add Transaction</button>
        </div>
      </div>
