...
<div class="page-content">
  <div class="page-header">
    ...
    <div class="page-header-text">
      <h2>Client Registration &amp; KYC</h2>
      <p>Manage client onboarding, personal information, and identity verification.</p>
    </div>
    <div class="page-header-actions">
      <button class="btn btn-primary"><i class='bx bx-user-plus'></i> Add Client</button>
    </div>
  </div>

  <div class="stat-grid">
    <div class="stat-card"><div class="stat-icon blue"><i class='bx bx-group'></i></div><div class="stat-info"><div class="stat-label">Total Clients</div><div class="stat-value">0</div><div class="stat-sub">All registered</div></div></div>
    <div class="stat-card"><div class="stat-icon green"><i class='bx bx-user-check'></i></div><div class="stat-info"><div class="stat-label">Active Clients</div><div class="stat-value">0</div><div class="stat-sub">Currently active</div></div></div>
    <div class="stat-card"><div class="stat-icon orange"><i class='bx bx-time'></i></div><div class="stat-info"><div class="stat-label">Pending KYC</div><div class="stat-value">0</div><div class="stat-sub">Awaiting review</div></div></div>
    <div class="stat-card"><div class="stat-icon teal"><i class='bx bx-shield-check'></i></div><div class="stat-info"><div class="stat-label">Verified KYC</div><div class="stat-value">0</div><div class="stat-sub">Identity confirmed</div></div></div>
  </div>

  <div class="card">
    <div class="tab-bar">
      <button class="tab-btn active" onclick="switchTab(this,'tab-clients')">Clients</button>
      <button class="tab-btn" onclick="switchTab(this,'tab-kyc')">KYC Verification</button>
    </div>
    ...
    <div id="tab-clients" class="tab-pane active">
      <div class="card-header" style="border-top:none;border-bottom:1px solid var(--border);">
        ...
        <div class="card-actions"><button class="btn btn-primary btn-sm"><i class='bx bx-user-plus'></i> Add Client</button></div>
      </div>
      <div class="table-wrap">
        <table>
          <thead><tr><th>Name</th><th>Gender</th><th>Contact</th><th>Email</th><th>Status</th><th>Date</th><th>Actions</th></tr></thead>
          <tbody><tr><td colspan="7"><div class="empty-state"><i class='bx bx-user-x'></i><p>No records found.</p></div></td></tr></tbody>
        </table>
      </div>
    </div>
    ...
    <div id="tab-kyc" class="tab-pane">
      <div class="card-header" style="border-top:none;border-bottom:1px solid var(--border);">
        <div class="card-title"><i class='bx bx-id-card'></i> KYC Verification</div>
        <div class="card-actions"><button class="btn btn-primary btn-sm"><i class='bx bx-plus'></i> Add KYC Record</button></div>
      </div>
      <div class="table-wrap">
        <table>
          <thead><tr><th>Client</th><th>ID Type</th><th>ID Number</th><th>Status</th><th>Verified By</th><th>Date</th><th>Actions</th></tr></thead>
          <tbody><tr><td colspan="7"><div class="empty-state"><i class='bx bx-id-card'></i><p>No records found.</p></div></td></tr></tbody>
        </table>
      </div>
    </div>
  </div>
