...
<div class="page-content">
  ...
  <div class="page-header">
    ...
    <div class="page-header-text">
      <h2>Group Lending &amp; Solidarity Mechanism</h2>
      <p>Manage client lending groups, roles, and group-based loan guarantees.</p>
    </div>
    <div class="page-header-actions">
      <button class="btn btn-primary"><i class='bx bx-plus'></i> New Group</button>
    </div>
  </div>
  ...
  <div class="stat-grid">
    ...
    <div class="stat-card">
      ...
      <div class="stat-info">
        ...
        <div class="stat-value">0</div>
        <div class="stat-sub">Currently operating</div>
      </div>
    </div>
    <div class="stat-card">
      <div class="stat-icon orange"><i class='bx bx-user-pin'></i></div>
      <div class="stat-info">
    ...
    <div class="stat-card">
      ...
      <div class="stat-info">
        <div class="stat-label">Groups with Loans</div>
        <div class="stat-value">0</div>
        <div class="stat-sub">Active loan groups</div>
      </div>
    </div>
  </div>
  ...
  <div class="card">
    ...
    <!-- Tab Bar -->
    <div class="tab-bar">
      <button class="tab-btn active" onclick="switchTab(this,'tab-groups')">Lending Groups</button>
      <button class="tab-btn" onclick="switchTab(this,'tab-members')">Group Members</button>
    </div>
    ...
    <div id="tab-groups" class="tab-pane active">
      ...
      <div class="card-header" style="border-top:none;border-bottom:1px solid var(--border);">
        <div class="card-title"><i class='bx bx-group'></i> Lending Groups</div>
        <div class="card-actions">
          <button class="btn btn-primary btn-sm"><i class='bx bx-plus'></i> New Group</button>
        </div>
      </div>

      <!-- Lending Groups Table -->
    ...
    <div id="tab-members" class="tab-pane">
      ...
      <!-- Tab Card Header -->
      <div class="card-header" style="border-top:none;border-bottom:1px solid var(--border);">
        <div class="card-title"><i class='bx bx-user-plus'></i> Group Members</div>
        <div class="card-actions">
          <button class="btn btn-primary btn-sm"><i class='bx bx-plus'></i> Add Member</button>
        </div>
      </div>
